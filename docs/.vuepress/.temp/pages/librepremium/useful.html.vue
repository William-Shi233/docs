<template><div><h1 id="有用的玩意" tabindex="-1"><a class="header-anchor" href="#有用的玩意" aria-hidden="true">#</a> 有用的玩意</h1>
<h2 id="配置文件" tabindex="-1"><a class="header-anchor" href="#配置文件" aria-hidden="true">#</a> 配置文件</h2>
<p><strong>此配置文件部分内容可能与实际内容不一致</strong><br>
<em>中文版配置文件仅供参考，以英文页面内容为准。</em><br>
<em>请同时对照英文Wiki与本地生成的配置文件按照需求修改。</em><br>
<em>由于我不是插件作者，中文版配置文件可能不会及时更新，请谅解</em></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>#  !!此配置文件使用HOCON语法!!
...
use-titles=true
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="语言文件" tabindex="-1"><a class="header-anchor" href="#语言文件" aria-hidden="true">#</a> 语言文件</h2>
<p><strong>此消息文件部分内容可能与实际内容不一致</strong><br>
<em>中文版消息文件仅供参考，以英文页面内容为准。</em><br>
<em>请同时对照英文Wiki与本地生成的消息文件按照需求修改。</em><br>
<em>由于我不是插件作者，中文版消息文件可能不会及时更新，请谅解</em></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>#  !!此配置文件使用HOCON语法!!
#  hocon语法与Json类似，但是它额外添加了一些功能
#  你可以在此页面中找到关于hocon的更多信息
#  https://docs.spongepowered.org/stable/en/server/getting-started/configuration/hocon.html
